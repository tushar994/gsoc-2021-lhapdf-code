...
employee_file = open('./custom_func_data/my_info.csv', mode='w')
employee_writer = csv.writer(employee_file, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)


employee_file_x = open('./custom_func_data/x.csv', mode='w')
employee_writer_x = csv.writer(employee_file_x, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

employee_file_q = open('./custom_func_data/q.csv', mode='w')
employee_writer_q = csv.writer(employee_file_q, delimiter=',', quotechar='"', quoting=csv.QUOTE_MINIMAL)

employee_file_data = open('./custom_func_data/data.dat', mode='w')
...
for val_x in ln_x:
    for val_q in ln_q:
        employee_writer.writerow([custom_func(val_x,val_q),val_x,val_q])
